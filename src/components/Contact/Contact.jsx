...
const Contact = () => {
  ...
  <form ref={form}  onSubmit={sendEmail}  className='w-96 justify-center mt-3'  >
      <div className='font-bold text-green-400 mt-2'><label>Name</label></div>
      <div className=''><input className='w-72 border rounded-xl border-green-400  p-2'  type="text" name="from_name"   autocomplete="name"/></div>
      <div className='font-bold text-green-400'><label>Email</label></div>
      <div><input
    className='w-72 border rounded-xl border-green-400 p-2 text-black'
    type="email"
    name="from_email"
    autocomplete="email"   
  /></div>
      ...
      <button className='bg-green-400 p-3 text-white rounded-xl mt-3 flex items-center  w-72 justify-center'><FaTelegramPlane /><input className='ms-2'  type="submit" value="Send" /></button>
    </form>
      </div>
     </div>
       </div>
